/*
 * Single stochastic mutant-epidemic trajectory simulation.
...
#define LIMIT 100
	...
	int n, *con, *Pi, *Pf, *degree, **state, **Ni, **pos, **Ea, i, seed_node, j, k, l, max, sum, total_degree, gmax, ni, *Ninf, *Nedg, Aux, strains, a;
	FILE *input_file, *Pc, *Clust, *Knngraf, *Evol;
	char input_filename[20];
	double PC, KNN, CLUST, aux, aux2, sim_time, event_time_increment;
	bool control;
